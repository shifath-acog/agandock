# **Docking Pipeline**
Uni-Dock is a GPU-accelerated molecular docking program. It supports various scoring functions including vina, vinardo, and ad4. Uni-Dock achieves more than 1000-fold speed-up on V100 GPU with high-accuracy compared with the AutoDock Vina running in single CPU core. 

# Docker Setup and Usage
Note: Make sure you have Docker installed on your system.
1. ![#ffa500](https://via.placeholder.com/15/ffa500/ffa500.png) Clone the repository to your local machine: `git clone git@github.com:aganitha/SMOLdiscovery.git`

2. ![#ffa500](https://via.placeholder.com/15/ffa500/ffa500.png) Navigate to the project directory "**PROTAC**" and run the following commands to build the Docker image :`make build-image`
...
Once you are inside Jupyterlab container, you have to execute two notebooks, "1_protac_filter" and "2_protac_filter" simultaneously.
...
- Antarip Halder  <antarip@aganitha.ai>
- Geeta Mounika <geeta@aganitha.in>
- Kailash Lohar  <kailash@aganitha.ai>
